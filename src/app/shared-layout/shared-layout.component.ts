...
toggleDownloadMenu() {
  ...
  const urls = {
    pdf: 'https://cmms-api.ilizien-projects-cdf.in/media/ppt/Relaza-Innovating-CMMS-POC.pdf',
    pptx: 'https://cmms-api.ilizien-projects-cdf.in/media/ppt/Relaza-Innovating-CMMS-POC.pptx'
  };

...
export class DataProcessingService {
      ...
      datasets: [
        {
          ...
          backgroundColor: [
            ...
            '#84CC16', '#6366F1', '#14B8A6', '#F43F5E', '#A855F7', '#0EA5E9', '#FBBF24', '#34D399'
          ],
          hoverBackgroundColor: [
            '#2563EB', '#059669', '#D97706', '#DC2626', '#7C3AED', '#0891B2', '#EA580C', '#DB2777',
            '#65A30D', '#4F46E5', '#0D9488', '#E11D48', '#9333EA', '#0284C7', '#F59E0B', '#10B981'
          ]
        }
      ]
    };
      ...
      datasets: [
        {
          ...
          backgroundColor: ['#10B981', '#EF4444'], // Beautiful green for mapped, vibrant red for unmapped
  ...
  private getShipTypeColor(type: string, isHover: boolean = false): string {
    const colors: { [key: string]: string } = {
      'Carrier': '#10B981', // Beautiful green
      'Destroyer': '#3B82F6', // Vibrant blue
      'Frigate': '#F59E0B', // Warm amber
      'Submarine': '#8B5CF6', // Rich purple
      'Corvette': '#EF4444'  // Vibrant red
    };
  ...
  private getCommandColor(commandName: string, isTransparent: boolean = false): string {
    const colors: { [key: string]: string } = {
      'Eastern Naval Command': '#8B5CF6', // Beautiful purple
      'Western Naval Command': '#EC4899', // Vibrant pink
      'Southern Naval Command': '#F97316', // Warm orange
    };
    const color = colors[commandName] || '#cccccc'; // Default gray
    if (isTransparent) {
      // Convert hex to rgba with 0.15 alpha for subtle fill
